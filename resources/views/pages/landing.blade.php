                        ...
                        <div class="mi-card-container m-2">
                            <div class="mi-card-bdy p-3">
                                ...
                                <div class="mi-card-loc text-end">
                                    <label class="mi-card-loc-label">School Road, Hetauda <span><i class="fa-solid fa-location-dot"></i></span> </label>
                                    <label class="mi-card-loc-label-cmp"> Alpha Tech IT company </label>
                                </div>
                        ...
                        <div class="mi-card-container m-2">
                            <div class="mi-card-bdy p-3">
                                ...
                                <div class="mi-card-content p-3">
                                    ...
                                    <label class="mi-card-badge mi-card-badge-job">
